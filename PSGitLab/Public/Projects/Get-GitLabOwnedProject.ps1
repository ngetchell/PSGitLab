...
<#
.SYNOPSIS
Gets all of the projects owned by the user making the API call associated with a GitLab domain. 
.DESCRIPTION
Gets all of the projects owned by the user making the API call associated with a GitLab domain. This uses the v3 GitLab API. 
.EXAMPLE
